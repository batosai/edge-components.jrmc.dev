...
router.on('/button/about').render('pages/about', { group: 'actions', name: 'button' }).as('about-button')
router.on('/drawer').render('pages/actions/drawer').as('drawer')
router.on('/drawer/about').render('pages/about', { group: 'actions', name: 'drawer' }).as('about-drawer')
router.on('/dropdown').render('pages/actions/dropdown').as('dropdown')
router.on('/dropdown/about').render('pages/about', { group: 'actions', name: 'dropdown' }).as('about-dropdown')
router.on('/modal').render('pages/actions/modal').as('modal')
router.on('/modal/about').render('pages/about', { group: 'actions', name: 'modal' }).as('about-modal')

router.on('/alert').render('pages/display/alert').as('alert')
router.on('/alert/about').render('pages/about', { group: 'display', name: 'alert' }).as('about-alert')
router.on('/avatar').render('pages/display/avatar').as('avatar')
router.on('/avatar/about').render('pages/about', { group: 'display', name: 'avatar' }).as('about-avatar')
router.on('/badge').render('pages/display/badge').as('badge')
router.on('/badge/about').render('pages/about', { group: 'display', name: 'badge' }).as('about-badge')
...
router.on('/carousel/about').render('pages/about', { group: 'display', name: 'carousel' }).as('about-carousel')
...
router.on('/loading/about').render('pages/about', { group: 'display', name: 'loading' }).as('about-loading')
router.on('/progress').render('pages/display/progress').as('progress')
router.on('/progress/about').render('pages/about', { group: 'display', name: 'progress' }).as('about-progress')
router.on('/table').render('pages/display/table').as('table')
router.on('/table/about').render('pages/about', { group: 'display', name: 'table' }).as('about-table')
router.on('/toast').render('pages/display/toast').as('toast')
router.on('/toast/about').render('pages/about', { group: 'display', name: 'toast' }).as('about-toast')
router.on('/tooltip').render('pages/display/tooltip').as('tooltip')
router.on('/tooltip/about').render('pages/about', { group: 'display', name: 'tooltip' }).as('about-tooltip')

router.on('/checkbox').render('pages/form/checkbox').as('checkbox')
router.on('/checkbox/about').render('pages/about', { group: 'form', name: 'checkbox' }).as('about-checkbox')
router.on('/container').render('pages/form/container').as('container')
router.on('/container/about').render('pages/about', { group: 'form', name: 'container' }).as('about-container')
router.on('/control').render('pages/form/control').as('control')
router.on('/control/about').render('pages/about', { group: 'form', name: 'control' }).as('about-control')
...
router.on('/select/about').render('pages/about', { group: 'form', name: 'select' }).as('about-select')
router.on('/textarea').render('pages/form/textarea').as('textarea')
router.on('/textarea/about').render('pages/about', { group: 'form', name: 'textarea' }).as('about-textarea')
router.on('/toggle').render('pages/form/toggle').as('toggle')
router.on('/toggle/about').render('pages/about', { group: 'form', name: 'toggle' }).as('about-toggle')
...
router.on('/pagination/about').render('pages/about', { group: 'navigation', name: 'pagination' }).as('about-pagination')
